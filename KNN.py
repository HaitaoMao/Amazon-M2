'''
Adapt from the offical implemenation of "Sequence and Time Aware Neighborhood for Session-based Recommendations"
https://github.com/xiaohanhan1019/STAN
'''
...
class SKNN:
    def __init__(self, session_id, session, sample_size=0, k=500):
        self.k = k
    ...
    def predict(self, session_id, session_items, k=20):
