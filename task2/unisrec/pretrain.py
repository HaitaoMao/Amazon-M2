...
from recbole.utils import init_seed, init_logger, ensure_dir
...
def pretrain(dataset, **kwargs):
    ...
    props = ['unisrec/props/UniSRec.yaml', 'unisrec/props/pretrain.yaml']
    print(props)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', type=str, default='dju', help='dataset name')
